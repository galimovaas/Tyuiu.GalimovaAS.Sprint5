using Tyuiu.GalimovaAS.Sprint5.Task6.V21.Lib;
namespace Tyuiu.GalimovaAS.Sprint5.Task6.V21
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string path = @"C:\Users\alina\source\repos\Tyuiu.GalimovaAS.Sprint5\DataSprint5\InPutDataFileTask6V21.txt";
