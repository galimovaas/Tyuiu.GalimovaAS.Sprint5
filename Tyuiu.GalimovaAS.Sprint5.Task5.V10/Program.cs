using Tyuiu.GalimovaAS.Sprint5.Task5.V10.Lib;
namespace Tyuiu.GalimovaAS.Sprint5.Task5.V10
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Выполнил: Выполнила: Галимова А.С. | АСОиУБ-24-1                        *");
            Console.WriteLine("***************************************************************************");
            ...
            string path = @"C:\Users\alina\source\repos\Tyuiu.GalimovaAS.Sprint5\DataSprint5\InPutDataFileTask5V10.txt";
